...
$_['text_mail_custom']               = 'Additional settings';
...
$_['entry_autocomplete_admin']       = 'Autocomplete items count (Admin)';
...
$_['entry_seo_url_postfix']          = 'Add postfix .html';
$_['entry_seo_url_slash']            = 'Add \'/\' to the end of the link';
$_['entry_seo_canonical_first']      = 'The first page is canonical';
...
$_['entry_enquiry_allow_links']      = 'Allow hyperlinks in feedback form';
$_['entry_seo_no_description']       = 'Description only on the first page';
$_['entry_seo_title_page']           = 'Add (Page - N) for title';
$_['entry_seo_meta_description_page']= 'Add (Page - N) for meta description';

$_['entry_seo_url_mode']             = 'Friendly URL operating mode';
$_['text_seo_url_mode0']             = 'Default';
$_['text_seo_url_mode1']             = 'Friendly URL as https://{сайт}/<b>{товар}</b>';
$_['text_seo_url_mode2']             = 'Friendly URL as https://{сайт}/<b>{категория1}/{категория2}/{товар}</b>';
$_['text_seo_url_mode3']             = 'Friendly URL as https://{сайт}/<b>{производитель}/{товар}</b>';
$_['text_seo_url_mode4']             = 'Friendly URL as https://{сайт}/<b>{товар}</b>, для категории https://{сайт}/<b>{категория без подкатегорий}</b>';
$_['help_seo_url_mode0']             = 'In this mode, the friendly URL is generated based on the transition source. If we come to a product from a manufacturer, then the friendly URL will contain the manufacturer. If we move from a category, then the friendly URL will contain the path to the category from which the transition was made. If we move from other places, then the friendly URL contains only the product.<br> Product breadcrumbs will be built by the main category. In this mode, the <b>canonical</b> attribute always contains a link to the product, without additional parameters.';
$_['help_seo_url_mode1']             = 'All store product links will contain only the friendly URL of the product without additional components.<br> Product breadcrumbs will be built by the main category. The <b>canonical</b> attribute always contains a link to the product, without additional parameters. All other variants of product links make a <b>301</b> redirect to the canonical page.';
$_['help_seo_url_mode2']             = 'All store product links will contain the product NC and path NC for the main category.<br> Product breadcrumbs will be built by the main category. The <b>canonical</b> attribute always contains a link to the product indicating the path of the main category. All other variants of product links make a <b>301</b> redirect to the canonical page.';
$_['help_seo_url_mode3']             = 'All product links of the store will contain the friendly URL of the product and the friendly URL of the manufacturer.<br> Product breadcrumbs will be built by manufacturer. The <b>canonical</b> attribute always contains a link to the product indicating the manufacturer. All other variants of product links make a <b>301</b> redirect to the canonical page.';
$_['help_seo_url_mode4']             = 'Links to products and store categories will only contain product/category friendly URLs without additional components.<br> Product breadcrumbs will be built by the main category. Category breadcrumbs will be built along the path to the current category. The <b>canonical</b> attribute always contains a link to the product/category, without additional parameters. All other link options are redirected to a <b>301</b> canonical page.';
...
$_['help_autocomplete_admin']        = 'The number of autocomplete elements displayed for the administrator (products, options, manufacturers, customers, etc.).';
...
$_['help_seo_url_postfix']           = 'The ending will be added to product and information links.';
$_['help_seo_url_slash']             = 'The slash will be added only to links that do not have an ending: category, manufacturer, etc.';
$_['help_seo_canonical_first']       = 'The first page of pagination should be designated as canonical for categories, manufacturer\'s products and special.';
...
$_['help_enquiry_allow_links']       = 'If you allow the sending of hyperlinks, this may lead to an increase in the number of spam emails.';
$_['help_seo_no_description']        = 'When this setting is enabled, the description on the category and manufacturer page will be shown only on the first page.';
$_['help_seo_title_page']            = 'Adds text with page numbering to the title of the category, manufacturer, search, promotions page.<br>On all pagination pages except the first.';
$_['help_seo_meta_description_page'] = 'Adds text with page numbering to the meta description of the category, manufacturer, search, promotions page.<br>On all pagination pages except the first.';
...
$_['error_autocomplete']             = 'You must specify! Recommended value: 10.';
