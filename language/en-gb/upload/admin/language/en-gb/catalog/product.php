...
$_['text_from']              = 'from';
$_['text_to']                = 'to';
$_['text_no_manufacturer']   = '--- No manufacturer ---';
$_['text_no_category']       = '--- No category ---';
$_['text_no_main_category']  = 'No top category';
...
$_['entry_main_category']    = 'Product main category';
$_['entry_no_index']         = 'No index';
...
$_['help_main_category']     = 'In the list you can select the product main category. If it is selected, then product breadcrumbs will be built by the main product category.<br> If the main category is not selected, then breadcrumbs will be built by one of the product categories with maximum nesting.';
$_['help_no_index']          = 'When enabled, adds a HTTP header to the page - X-Robots-Tag: noindex';
