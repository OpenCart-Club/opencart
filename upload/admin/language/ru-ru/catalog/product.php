...
$_['column_image']           = '<span style="min-width: 25px;" data-toggle="tooltip" title="Изображения"><i class="fa fa-picture-o"></i></span> ';
...
$_['error_keyword']          = 'Этот SEO URL уже используется!';
$_['error_unique']           = 'SEO URL должен быть уникальным на всю систему!';